...
# define ERROR_MAP_MULTI_PLAYER \
	"Invalid map: multiple player cells detected."
# define ERROR_MAP_NO_PLAYER \
	"Invalid map: player cell required (N S W E)."

/* MLX */
# define ERROR_MLX_CONNECTION \
	"MLX: Failed to create X-Window connection."
# define ERROR_MLX_WINDOW \
